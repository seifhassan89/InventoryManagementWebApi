        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Items_MeasuringUnits_MeasuringUnitId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestTypeId = table.Column<int>(type: "int", nullable: false),
                    StockFromId = table.Column<int>(type: "int", nullable: false),
                    StockToId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Requests_Stocks_StockFromId",
                        column: x => x.StockFromId,
                        principalTable: "Stocks",
                        principalColumn: "StockId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Requests_Stocks_StockToId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Requests_StockFromId",
                table: "Requests",
                column: "StockFromId");

            migrationBuilder.CreateIndex(
                name: "IX_Requests_StockToId",
                table: "Requests",
                column: "StockToId");
